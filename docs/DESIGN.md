...
LockPower is intentionally small. A user LaunchAgent starts one native process
at login. The process subscribes to public macOS workspace and distributed
notifications for screen lock, unlock, display sleep, and display wake events.
